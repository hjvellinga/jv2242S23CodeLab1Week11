...
public class Directory : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        NYUPerson sirSomeone = new NYUAdjunct(name: "Sir Someone",
            netId: "ss1234",
            salary: 1, 
            tenure: false,
            adjunctFaculty: true);

        NYUPerson missSomeoneElse = new NYUAlumni(
            name: "Miss Someone Else",
            netId: "se1234",
            gpa: 100f,
            credits: 63,
            graduationDate: 2023);
        ...
        nyuPeopleList.Add(sirSomeone);
        nyuPeopleList.Add(missSomeoneElse);
